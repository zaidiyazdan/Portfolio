...
const About = () => {
  return (
    <div className="bg-gradient-to-b bg-gray-900 py-16 to-blue-900 from-black">
      <div className="text-left  flex justify-center  flex-col gap-3">
        ...
        <p className="italic font-kanit">I am <span className="text-blue-400 underline">Ali Yazdan</span>,3rd year student with a love for creating meaningful projects and solving complex problems . My journey has been of continuous learning and growth, fueled by a desire to innovate and make a positive impact. </p>
