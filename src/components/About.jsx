  ...
  return (
    <div className="bg-gradient-to-b  to-blue-950 from-black py-16">
      ...
      <div className="text-left  flex justify-center  flex-col py-12 gap-3">
        ...
        <p className="">I am <span className="text-blue-400 underline">Ali Yazdan</span>, 3rd year student studying in ISE branch with a love for creating meaningful projects and solving complex problems . My journey has been of continuous learning and growth, fueled by a desire to innovate and make a positive impact. </p>
        <p className="py-4"> 
