        ...
        {!play && (
          <div className="text-white text-md p-4 rounded-xl h-[300px]">
            <p>
              ...
              weaving its melodies through my memories and emotions. Whether its
              the rhythm of a favorite song lifting my spirits or the lyrics of
              a meaningful tune resonating deeply within me, music has always
              been a source of comfort and inspiration. Each melody is like a
              bookmark in the story of my life, evoking nostalgia, joy, and
              sometimes even solace during difficult times. Music is not just a
              passion for me; its a language that speaks to my soul, connecting
              me to the world and to myself in profound ways
            </p>
          </div>
        )}
      </div>
