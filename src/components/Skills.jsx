    ...
    <div className="bg-gradient-to-b to-blue-950 from-black py-16">
      ...
      <div className="px-30 text-white">
        <div className="px-6 sm:px-32 md:px-60">
          ...
          {/* <p className="mb-3">
            My favorite part of Web Development i would say, I absolutely love
            creating functional and minimalistic websites that users from all
            over the world can have a good time using. You wll mostly catch me
            hands deep in these languages
          </p> */}
